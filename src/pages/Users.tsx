        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4">
            ...
            <button 
              ...
              className="flex-1 px-4 py-3.5 rounded-xl bg-brand-accent text-white hover:bg-brand-accent-hover font-black uppercase tracking-widest transition-all shadow-[0_4px_20px_rgba(192,38,211,0.2)] text-[10px] order-1 sm:order-2"
            >
              Sync Assets
            </button>
          </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            <button className="flex-1 md:flex-none px-6 py-2.5 bg-brand-accent text-white rounded-xl font-black hover:bg-brand-accent-hover transition-all text-[10px] uppercase tracking-widest shadow-[0_8px_20px_rgba(192,38,211,0.2)] flex items-center justify-center gap-2">
